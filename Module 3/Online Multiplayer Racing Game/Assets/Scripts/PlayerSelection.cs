...
public class PlayerSelection : MonoBehaviour
{
    ...
    private void ActivatePlayer (int x) // select player screen thing
    {
    ...
    public void goToNextPlayer()
    {
        ...
        if (playerSelectionNumber >= SelectablePlayers.Length) // wraps the selection back to 0 (start)
        {
            playerSelectionNumber = 0; 
        }
    ...
    public void goToPrevPlayer()
    {
        ...
        if (playerSelectionNumber < 0) // wraps the selection back to 0 (start)
        {
